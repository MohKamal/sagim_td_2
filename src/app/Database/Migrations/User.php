...
namespace  Showcase\Database\Migrations {
    ...
    class User extends Table{
        ...
        function handle(){
            ...
            $this->column(
                Column::factory()->name('address')->string()->nullable()
            );
            $this->column(
                Column::factory()->name('address2')->string()->nullable()
            );
            $this->column(
                Column::factory()->name('zip')->string()->nullable()
            );
            $this->column(
                Column::factory()->name('country')->string()->nullable()
            );
            $this->column(
                Column::factory()->name('state')->string()->nullable()
            );
            $this->column(
